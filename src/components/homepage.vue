...
<v-carousel hide-delimiters>
    <v-carousel-item src="/jason-leung-poI7DelFiVA-unsplash.jpg" cover> </v-carousel-item>
    <v-carousel-item src="/orijit-chatterjee-wEBg_pYtynw-unsplash.jpg" cover> </v-carousel-item>
    <v-carousel-item src="/sara-cervera-xB0Kr0D0C8Y-unsplash.jpg" cover> </v-carousel-item>
    <v-carousel-item src="/amirali-mirhashemian-v2z6Yhp_6Gc-unsplash.jpg" cover> </v-carousel-item>
